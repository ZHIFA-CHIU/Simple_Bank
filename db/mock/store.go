...
// Source: github.com/zhifaq/simple_bank/sqlc (interfaces: Store)
//
...
import (
	...
	sqlc "github.com/zhifaq/simple_bank/sqlc"
...
func (m *MockStore) GetEntries(ctx context.Context, arg sqlc.GetEntriesParams) ([]sqlc.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfers(ctx context.Context, arg sqlc.GetTransfersParams) ([]sqlc.Transfer, error) {
	m.ctrl.T.Helper()
